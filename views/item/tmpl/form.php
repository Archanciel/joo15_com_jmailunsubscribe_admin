...
<tr>
	<td valign="top">
		...
		<table class="adminform">
			<tbody>
				<tr><td width="100" align="right"><label for="alertid"><?php echo JText::_( 'Alertid' ) ?>:</label></td><td><input class="text_area" type="text" name="alertid" id="alertid" size="32" maxlength="250" value="<?php echo $this->item->alertid ?>" /></td></tr>
<tr><td width="100" align="right"><label for="subscribed"><?php echo JText::_( 'Subscribed' ) ?>:</label></td><td><input class="text_area" type="text" name="subscribed" id="subscribed" size="32" maxlength="250" value="<?php echo $this->item->subscribed ?>" /></td></tr>
<tr><td width="100" align="right"><label for="pluginssubscribedto"><?php echo JText::_( 'Pluginssubscribedto' ) ?>:</label></td><td><input class="text_area" type="text" name="pluginssubscribedto" id="pluginssubscribedto" size="32" maxlength="250" value="<?php echo $this->item->pluginssubscribedto ?>" /></td></tr>
...
<div>Diese Komponente wurde mit <a href="http://joodo.hopper-intermedia.de">jooDo!</a> erstellt. Ein Service von <a href="http://hopper-intermedia.de">hopper intermedia</a>.</div>